...
class Event {
  ...
  String get getEventDocumentID => _eventDocumentID;
  set setEventDocumentID(final String eventDocumentID) =>
      _eventDocumentID = eventDocumentID;

  String? get getTitle => _title;
  set setTitle(final String title) => _title = title;

  BabylonUser? get getCreator => _creator;
  ...
  List<BabylonUser?> get getAttendees => _attendees;
  set setAttendees(final List<BabylonUser?> attendees) =>
